...
This algorithm works with a system of visibility, and parkouring of the closest neighboring point of the polygon.
...
Within the Jupyter notebook, the two first sections, being the **Classes definition** and the **Utility functions** needs to be executed once.
